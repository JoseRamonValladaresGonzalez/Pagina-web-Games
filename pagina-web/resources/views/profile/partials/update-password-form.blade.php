<section class="profile-form">
    ...
    <form method="post" action="{{ route('password.update') }}" class="cyber-form">
        @csrf
        @method('put')
        ...
        <div class="input-group">
            ...
            <x-text-input id="update_password_current_password" name="current_password" 
                        type="password" class="input-field" autocomplete="current-password" />
        ...
        <div class="input-group">
            ...
            <x-text-input id="update_password_password" name="password" 
                        type="password" class="input-field" autocomplete="new-password" />
